...
public class Dashboard extends JFrame {
	...
	public Dashboard() {
		...
		JLabel firstLastName = new JLabel("ΔΙΟΝΥΣΗΣ ΒΟΣΣΟΣ");
		...
		JLabel lblViewRegistry = new JLabel("Προβολή Μητρώου Εκπαιδευτών");
		lblViewRegistry.setFont(new Font("Tahoma", Font.BOLD, 12));
		lblViewRegistry.setBounds(202, 129, 237, 38);
		contentPane.add(lblViewRegistry);
		
		JLabel lblViewCertRegistry = new JLabel("Προβολή Μητρώου Εγγεγραμμένων Εκπαιδευτών στο Μητρώο του Coding Factory");
		lblViewCertRegistry.setFont(new Font("Tahoma", Font.PLAIN, 12));
		lblViewCertRegistry.setBounds(202, 148, 533, 38);
		contentPane.add(lblViewCertRegistry);
